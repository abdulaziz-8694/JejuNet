...
public class SegmentorActivity extends CameraActivity implements OnImageAvailableListener {
  ...
  public static final int TF_OD_API_INPUT_WIDTH = 257;
  public static final int TF_OD_API_INPUT_HEIGHT = 257;
  public static final int TF_OD_API_NUM_CLASS = 21;
  public static final int TF_OD_API_NUM_OUTPUT = 21;
